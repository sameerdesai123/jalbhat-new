...
vol_dependencies.child('ls').on('value',(snapshot) => {
...
vol_dependencies.child('total').on('value', (snapshot) =>{
...
health_dependencies.child('pH').on('value', (snapshot) =>{
...
health_dependencies.child('turbidity').on('value', (snapshot) =>{
...
health_dependencies.child('temp').on('value', (snapshot) =>{
